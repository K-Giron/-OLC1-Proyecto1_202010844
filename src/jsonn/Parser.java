...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\010\003\007\004\012\005\006\001\002\000\016" +
    "\003\ufff8\004\ufff8\005\ufff8\007\ufff8\010\ufff8\011\ufff8\001" +
    "\002\000\004\011\021\001\002\000\012\003\ufffe\004\ufffe" +
    "\005\ufffe\007\ufffe\001\002\000\012\003\007\004\012\005" +
    "\006\007\020\001\002\000\016\003\ufff9\004\ufff9\005\ufff9" +
    "\007\ufff9\010\ufff9\011\ufff9\001\002\000\016\003\ufffc\004" +
    "\ufffc\005\ufffc\007\ufffc\010\015\011\014\001\002\000\012" +
    "\003\ufffd\004\ufffd\005\ufffd\007\ufffd\001\002\000\006\004" +
    "\012\005\006\001\002\000\016\003\ufffa\004\ufffa\005\ufffa" +
    "\007\ufffa\010\ufffa\011\ufffa\001\002\000\012\003\uffff\004" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\010\003\010\004\007\005\012\001\001\000\002\001\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // inicio ::= LLAVE_A lista_instr LLAVE_C 
            {
              Object RESULT =null;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // instruccion ::= expresion COMA 
            {
              Object RESULT =null;
		...
		Object val = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 jsonn.Parser.resultado= jsonn.Parser.resultado+val.toString()+" \n"; 
		...
		Object val = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 jsonn.Parser.resultado= jsonn.Parser.resultado+val.toString()+" \n" ;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // expresion ::= expresion DOSPUNTOS expresion 
            {
              Object RESULT =null;
		...
		String val = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = val; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // expresion ::= TEXTOENTRECOMILLAS 
            {
              Object RESULT =null;
		int valleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int valright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		String val = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 String[] parte = val.split("\"");
                                                                    RESULT = parte[1]; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expresion",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
